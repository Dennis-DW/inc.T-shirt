...
const Footer = () => {
  return (
    <section class="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
      <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3">
          ...
          >
            ...
            <span class="self-center text-2xl font-semibold ">inc.T-Shirt</span>
          </a>
        </div>
        <div class="grid grid-cols-2 text-sm font-palanquin gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div class="space-y-3">
            <h3 class="font-bold text-coral-red">Product</h3>
            <ul class="space-y-1">
              <li>
          ...
          <div class="space-y-3">
            <h3 class="font-bold text-coral-red">Company</h3>
            <ul class="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
      ...
      <div class=" bg-gray-900">
        <div class="max-w-2xl mx-auto text-white py-4">
          <div class="text-center">
            ...
            <p> Cool Outfit. All day, every day. </p>
          ...
          <div class="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400"></div>
        </div>
      </div>
